	...
	function add_to_wishlist() {
		...
		if ($user != 0) {
			...
			$wpdb->query( $query_wp );
                ...
                $wt_add_to_wishlist_text = isset( $button_style_settings['wt_add_to_wishlist_text'] ) ? $button_style_settings['wt_add_to_wishlist_text']: __( 'Add to wishlist' );
                $wt_after_adding_product_text = isset( $button_style_settings['wt_after_adding_product_text'] ) ? $button_style_settings['wt_after_adding_product_text']: __( 'Added to wishlist' );
